...
person = input()
print("Okay", person, "welcome to the guessing game.", "Hope you're ready to play!",
...
while count < math.log(upper - lower + 1, 2):
    ...
    if guess == x:
        ...
        print("Congratulations!!", person, "you are the wiser and you did it in ", count, " tries!", "\U0001f600")
        exit()
